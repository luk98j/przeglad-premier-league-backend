...
public class ActualSeasonWriter {
    ...
    public void saveActualSeason(){
        JSONArray jsonArray = footballAPIService.callActualSeasonAndParseItToDatabase();
        JSONObject object;
        SeasonPeriod seasonPeriod = seasonPeriodService.getSeasonPeriod(footballAPIService.getPeriodOfSeason());
